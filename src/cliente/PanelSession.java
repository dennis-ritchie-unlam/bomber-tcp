...
public class PanelSession extends JPanel {
	...
	private ClienteVentanaMonstruo cliente;
	private PaqueteSession paqueteSession;

	public PanelSession(final ClienteVentanaMonstruo clienteVentanaMonstruo) {
		this.cliente = clienteVentanaMonstruo;
	}
	...
	/**
	 * @param cliente2 cliente que se logea
	 */
	private void logIn(final ClienteVentanaMonstruo cliente2) {
		synchronized (cliente2) {
		    cliente2.setAccion(Comando.INICIAR_SESION);
